...
var bleGamepad = {
    ...
    isPressed: function (idx, b) {
        var rst = jm.s({ '_fn': bleGamepadDefId, 'ty': bleGamepadType, 'op': 6, 'idx': idx, 'b': b });
    ...
    isConnected: function (idx) {
        var rst = jm.s({ '_fn': bleGamepadDefId, 'ty': bleGamepadType, 'op': 38, 'idx': idx });
        return rst && rst.code === 0 ? rst.v : false;
    },
     ...
     * @async
     */
    enterPairingMode: function (idx) {
        var rst = jm.s({ '_fn': bleGamepadDefId, 'ty': bleGamepadType, 'op': 43, 'idx': idx });
        return rst && rst.code === 0 ? rst.v : false;
    },
     ...
     * @async
     */
    isOutputReceived: function (idx) {
        var rst = jm.s({ '_fn': bleGamepadDefId, 'ty': bleGamepadType, 'op': 44, 'idx': idx });
        return rst && rst.code === 0 ? rst.v : false;
    },
     ...
     * @async
     */
    getDeviceName: function (idx) {
        var rst = jm.s({ '_fn': bleGamepadDefId, 'ty': bleGamepadType, 'op': 45, 'idx': idx });
     ...
     * @async
     */
    getDeviceManufacturer: function (idx) {
        var rst = jm.s({ '_fn': bleGamepadDefId, 'ty': bleGamepadType, 'op': 46, 'idx': idx });
        return rst && rst.code === 0 ? rst.v : "";
    },
